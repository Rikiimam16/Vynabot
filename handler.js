...
`.trim(), data.jid)
            ...
            if ((usedPrefix = (match[0] || '')[0])) {
                ...
                if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 7) {
                    this.reply(m.chat, `Yah limit Kamu sudah melebihi Kuota 🤓, Beli limit Dengan Cara *${usedPrefix}buylimit*`, m)
    ...
    case 'remove':
        if (chat.welcome) {
            ...
            for (let user of participants) {
                ...
                let ppUrl = await conn.profilePictureUrl(user, 'image').catch(() => 'https://telegra.ph/file/24fa902ead26340f3df2c.png');

                // Teks pesan untuk welcome atau bye
                let text = (action === 'add' ?
                ...
                // Kirim pesan dengan foto profil user
                conn.sendMessage(id, {
                    image: { url: ppUrl },
                    caption: text,
                });
...
let mssg = {
      ...
      contextInfo: {
      externalAdReply: {
      title: '✖️ A K S E S D I T O L A K,',
      body: '',
      thumbnailUrl: global.url.akses,
      sourceUrl: ``,
      mediaType: 1,
...
let msg = {
  ...
  if (msg) return conn.sendMessage(m.chat, {
    ...
    let daftar = {
  unreg: `
ʜᴀʟᴏ! ꜱᴇʙᴇʟᴜᴍ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ʙᴏᴛ ɪɴɪ
ꜱɪʟᴀᴋᴀɴ ʟᴀᴋᴜᴋᴀɴ ʀᴇɢɪꜱᴛʀᴀꜱɪ ᴛᴇʀʟᴇʙɪʜ ᴅᴀʜᴜʟᴜ.
...
ꜱᴇᴛᴇʟᴀʜ ʀᴇɢɪꜱᴛʀᴀꜱɪ, ᴀɴᴅᴀ ᴅᴀᴘᴀᴛ ʟᴀɴɢꜱᴜɴɢ
ᴍᴇɴɪᴋᴍᴀᴛɪ ʟᴀʏᴀɴᴀɴ ʙᴏᴛ.`}[type]
  ...
  if (daftar) return conn.sendMessage(m.chat, {
      ...
      thumbnailUrl: global.url.registrasi,
      sourceUrl: ``,
      mediaType: 1,
      renderLargerThumbnail: true
      }}}, { quoted: m})
